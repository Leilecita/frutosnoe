...
public class UserHistoryOrdersActivity extends BaseActivity implements Paginate.Callbacks, OnStartDragListener {
    ...
    public static void start(Context mContext, Client client){
        Intent i=new Intent(mContext, UserHistoryOrdersActivity.class);
        i.putExtra("ID",client.id);
        i.putExtra("NAME",client.name);
        i.putExtra("DIRECCION",client.address);
